...
set(_USE_LIBLZMA_DEFAULT OFF)

if(HUNTER_ENABLED)
    set(_USE_LIBLZMA_DEFAULT "hunter")

    wx_add_thirdparty_library(wxUSE_REGEX PCRE2 "enable support for wxRegEx class" DEFAULT "hunter")
    wx_add_thirdparty_library(wxUSE_ZLIB ZLIB "use zlib for LZW compression" DEFAULT "hunter")
    wx_add_thirdparty_library(wxUSE_EXPAT EXPAT "use expat for XML parsing" DEFAULT "hunter")
    wx_add_thirdparty_library(wxUSE_LIBJPEG JPEG "use libjpeg (JPEG file format)" DEFAULT "hunter")
    wx_add_thirdparty_library(wxUSE_LIBPNG PNG "use libpng (PNG image format)" DEFAULT "hunter")
    wx_add_thirdparty_library(wxUSE_LIBTIFF TIFF "use libtiff (TIFF file format)" DEFAULT "hunter")
    wx_add_thirdparty_library(wxUSE_LIBWEBP WebP "use libwebp (WebP file format)" DEFAULT "hunter")
    wx_add_thirdparty_library(wxUSE_NANOSVG NanoSVG "use NanoSVG for rasterizing SVG" DEFAULT "hunter")
    wx_add_thirdparty_library(wxUSE_SCINTILLA scintilla "use Scintilla" DEFAULT "hunter")
    wx_add_thirdparty_library(wxUSE_LEXILLA lexilla "use Lexilla" DEFAULT "hunter")
else()
    ...
    wx_add_thirdparty_library(wxUSE_SCINTILLA scintilla "use Scintilla" DEFAULT "builtin")
    wx_add_thirdparty_library(wxUSE_LEXILLA lexilla "use Lexilla" DEFAULT "builtin")
endif()

wx_option(wxUSE_LIBLZMA "use LZMA compression" ${_USE_LIBLZMA_DEFAULT} STRINGS builtin hunter sys)
