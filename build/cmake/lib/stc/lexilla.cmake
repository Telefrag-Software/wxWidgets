...
if(wxUSE_LEXILLA STREQUAL "hunter" AND HUNTER_ENABLED)
    hunter_add_package(lexilla)
    find_package(lexilla CONFIG REQUIRED)
    set(LEXILLA_LIBRARIES lexilla::lexilla)
    set(LEXILLA_INCLUDE "${LEXILLA_ROOT}/include")
    set_property(TARGET ${LEXILLA_LIBRARIES} PROPERTY IMPORTED_GLOBAL TRUE)
elseif(wxUSE_LEXILLA STREQUAL "builtin")
    include(../../source_groups.cmake)
    set(LEXILLA_SRC_DIR src/stc/lexilla)
    set(SCINTILLA_LIBRARIES wxlexilla)
