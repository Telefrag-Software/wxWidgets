...
elseif(wxUSE_REGEX STREQUAL "hunter" AND HUNTER_ENABLED)
    hunter_add_package(PCRE2)
    find_package(PCRE2 CONFIG REQUIRED)
    set(REGEX_LIBRARIES pcre2::pcre2-8-static)
    set(REGEX_INCLUDE_DIRS "${PCRE2_ROOT}/include")
    set_property(TARGET ${REGEX_LIBRARIES} PROPERTY IMPORTED_GLOBAL TRUE)
elseif(wxUSE_REGEX)
