...
if(wxUSE_LIBTIFF STREQUAL "builtin")
    ...
    target_link_libraries(wxtiff PRIVATE ${ZLIB_LIBRARIES_OVERRIDE} ${JPEG_LIBRARIES})
    set(TIFF_LIBRARIES wxtiff)
    set(TIFF_INCLUDE_DIRS ${wxSOURCE_DIR}/src/tiff/libtiff)
elseif(wxUSE_LIBTIFF STREQUAL "hunter" AND HUNTER_ENABLED)
    hunter_add_package(TIFF)
    find_package(TIFF CONFIG REQUIRED)
    set(TIFF_LIBRARIES TIFF::tiff)
    set(TIFF_INCLUDE_DIRS "${TIFF_ROOT}/include")
    set_property(TARGET ${TIFF_LIBRARIES} PROPERTY IMPORTED_GLOBAL TRUE)
