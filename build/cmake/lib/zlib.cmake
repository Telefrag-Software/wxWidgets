...
elseif(wxUSE_ZLIB STREQUAL "hunter" AND HUNTER_ENABLED)
    hunter_add_package(WXZLIB)
    find_package(WXZLIB CONFIG REQUIRED)
    set(ZLIB_LIBRARIES ZLIB::wxzlib)
    set(ZLIB_INCLUDE_DIRS "${WXZLIB_ROOT}/include")
elseif(wxUSE_ZLIB)
