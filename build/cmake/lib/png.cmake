...
if(wxUSE_LIBPNG STREQUAL "builtin")
    ...
    target_link_libraries(wxpng PRIVATE ${ZLIB_LIBRARIES_OVERRIDE})
    set(PNG_LIBRARIES wxpng)
    set(PNG_INCLUDE_DIRS ${wxSOURCE_DIR}/src/png)
elseif(wxUSE_LIBPNG STREQUAL "hunter" AND HUNTER_ENABLED)
    hunter_add_package(PNG)
    find_package(PNG CONFIG REQUIRED)
    set(PNG_LIBRARIES PNG::png_static)
    set(PNG_INCLUDE_DIRS "${PNG_ROOT}/include")
    set_property(TARGET ${PNG_LIBRARIES} PROPERTY IMPORTED_GLOBAL TRUE)
elseif(wxUSE_LIBPNG)
